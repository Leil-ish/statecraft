          ...
          >
            {nation ? (
              <div className="p-10 h-full flex flex-col relative z-10">
                <div className="flex justify-between items-start mb-8">
                  <div className="relative">
                    ...
                    <div className="relative w-14 h-14 rounded-2xl bg-blue-500/10 border border-blue-500/20 flex items-center justify-center text-2xl">
                      {nation.flag}
                    </div>
                  </div>
                  <Button
                ...
                <Button 
                  ...
                  disabled={isLoading}
                  className="mt-auto w-full h-14 rounded-2xl bg-white text-black hover:bg-blue-500 hover:text-white font-black text-xs uppercase tracking-widest transition-all duration-500 shadow-xl hover:shadow-blue-500/20"
                >
                  Synchronize
                </Button>
              </div>
              ...
              <div className="p-10 h-full flex flex-col items-center justify-center text-center space-y-6 relative z-10">
                ...
                <div className="space-y-2">
                  <h4 className="font-bold text-white/30 text-lg">Empty Data Bank</h4>
                  <p className="text-xs text-white/20 max-w-[200px] leading-relaxed">
                    Neural archives are empty. Initialize a new civilization sequence.
                  </p>
                </div>
                <Button 
                  variant="outline"
