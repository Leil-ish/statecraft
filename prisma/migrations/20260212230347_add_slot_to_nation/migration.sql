...
INSERT INTO "new_Nation" ("capital", "createdAt", "currency", "currentIssue", "decisionHistory", "era", "flag", "founded", "gameMode", "governmentType", "historyLog", "id", "issuesResolved", "leader", "motto", "name", "stats", "updatedAt", "userId") SELECT "capital", "createdAt", "currency", "currentIssue", "decisionHistory", "era", "flag", "founded", "gameMode", "governmentType", "historyLog", "id", "issuesResolved", "leader", "motto", "name", "stats", "updatedAt", "userId" FROM "Nation";
DROP TABLE "Nation";
